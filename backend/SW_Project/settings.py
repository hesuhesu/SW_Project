...
SECRET_KEY = 'django-insecure-v3vhu727ec3oe$4x*a0quwo0#w*as(i93d!z^6m$=xi!m5y7jt'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        # 'rest_framework.permissions.IsAuthenticated', 인증된 사용자만 api 엑세스
        'rest_framework.permissions.IsAuthenticatedOrReadOnly', # 읽기만 허용됨
    ],
